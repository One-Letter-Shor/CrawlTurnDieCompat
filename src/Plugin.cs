...
[assembly: AssemblyVersion(Plugin.CompiledVersion)]
...
[BepInPlugin(CompiledGuid, CompiledName, CompiledVersion)]
public sealed class Plugin : BaseUnityPlugin
{
    public const string
        CompiledGuid = "OneLetterShor.CrawlTurnDieCompat",
        CompiledName = "Crawl Turn Die Compat",
    ...
    private void On_RainWorld_OnModsInit(On.RainWorld.orig_OnModsInit orig, RainWorld rainWorld)
    {
        ...
        try
        {
            Mod = Utils.ModGetter.GetRequiredMod(CompiledGuid);
            Compat.CheckMods();
            ApplyHooksAndEvents();
        }
